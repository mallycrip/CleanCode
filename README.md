본 게시글은 로버트 C. 마틴저의 Clean Code라는 책을 바탕으로 작성하고 있습니다.<br/>
Clean Code라는 책을 단순 배끼는 것이 아닌, 이해한 내용을 바탕으로 작성하고 있어 책과 다른부분이 존재하거나 잘못된 이해한 부분이 있을 수도 있습니다. 또한 예시 코드를 Python으로 옮기면서 그릇되게 작성 된 부분이 있을 수 있습니다. 
잘못된 부분에 대해서 지적해 주시면 감사합니다.<br/><br/> 
# CleanCode
